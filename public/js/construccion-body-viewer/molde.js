...
//import {obtenerDatosFormulario} from '../datos-formulario.js';
//const { obtenerDatosFormulario } = require('../datos-formulario.js');
import obtenerDatosFormulario from '../datos-formulario.js';
...
const usarDatosFormulario = async () => {
	...
	const medidasVr = {
		...
		largespalda: datos.largespalda,
		largdelantero: datos.largdelantero, //45
		costadillo: datos.costadillo,
		pierna: datos.pierna,
		entrepierna: datos.entrepierna,
		brazo: datos.brazo,
	};
	...
	const medidasHz = {
		pecho: datos.pecho, // 88
		cintura: datos.cintura, // 72
		cadera: datos.cadera, // 94
		espalda: datos.espalda, // 35
		seppecho: datos.seppecho, // 17
	};
